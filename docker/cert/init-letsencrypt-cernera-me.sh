...
domains=(cernera.me www.cernera.me)
docker_compose_file="docker-compose.cernera-me.yml"
rsa_key_size=4096
data_path="./data/certbot"
email="cernerae@gmail.com" # Adding a valid address is strongly recommended
